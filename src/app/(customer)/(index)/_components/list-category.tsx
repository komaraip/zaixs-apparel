    ...
    <div id="categories" className="flex flex-col gap-[30px]">
            ...
            <div className="grid grid-cols-4 gap-[30px]">
                {categories.map((item) => (
                    ...
                    <div className="bg-white flex items-center gap-[14px] p-5 rounded-[20px] ring-1 ring-[#E5E5E5] hover:ring-2 hover:ring-[#FFC736] transition-all duration-300 w-full">                        <div className="w-12 h-12 flex shrink-0 rounded-full bg-[#0D5CD7] items-center justify-center overflow-hidden" >
                            <Image src="/assets/icons/mobile.svg" alt="icon" width={200} height={90}/>
                        </div>
