...
export default function CheckoutForm() {
    ...
    const [, formAction] = useActionState(storeOrderParams, initialState);
  ...
  return (
    <form action={formAction} id="checkout-info" className="container max-w-[1130px] mx-auto flex justify-between gap-5 mt-[50px] pb-[100px]">
        <div className="w-[650px] flex flex-col shrink-0 gap-4 h-fit">
            ...
            <div className="flex flex-col gap-5 p-[30px] rounded-3xl border border-[#E5E5E5] bg-white">                <div className="flex items-center gap-[10px] rounded-full border border-[#E5E5E5] p-[12px_20px] focus-within:ring-2 focus-within:ring-[#FFC736] transition-all duration-300">
                    ...
                    <div className="flex shrink-0">
                        <Image src="/assets/icons/house-2.svg" alt="icon" width={24} height={24} />
                    </div>
                ...
                <div className="flex items-center gap-[30px]">                    <div className="flex items-center gap-[10px] rounded-full border border-[#E5E5E5] p-[12px_20px] focus-within:ring-2 focus-within:ring-[#FFC736] transition-all duration-300">
                        <div className="flex shrink-0">
                            <Image src="/assets/icons/global.svg" alt="icon" width={24} height={24} />
                        </div>
                        ...
                        <div className="flex shrink-0">
                            <Image src="/assets/icons/location.svg" alt="icon" width={24} height={24} />
                        </div>
                ...
                </div>                <div className="flex items-start gap-[10px] rounded-[20px] border border-[#E5E5E5] p-[12px_20px] focus-within:ring-2 focus-within:ring-[#FFC736] transition-all duration-300">
                    <div className="flex shrink-0">
                        <Image src="/assets/icons/note.svg" alt="icon" width={24} height={24} />
                    </div>
                    ...
                    <div className="flex shrink-0">
                        <Image src="/assets/icons/call.svg" alt="icon" width={24} height={24} />
                    </div>
