<?php 
      $result = mysqli_query($conn,"SELECT * FROM shoes WHERE id='$_GET[id]'");
      ...
      if (isset($_POST['edit'])) {
            ...
            $result = mysqli_query($conn, "UPDATE shoes SET nama='$nama',barang='$barang',jenis='$jenis',harga='$harga',stok='$stok' WHERE id='$id' ");
