        ...
        <div id="layoutSidenav_content">
            <main>
                <div class="container-fluid px-4">
                    ...
                    <div class="card mb-4">
                        <div class="card-body">
                            <img src="../assets/images/profile.jpg" width="125"/>
                        </div>
                    </div>
                    <div class="card mb-4">
                        <div class="card-body">
                            <p class="mb-0">
                                Hello my name is Komara Indra Putra, i'm 17 years old.
                                I'm student of MAN 1 Semarang City and i love programming and coding is fun.
                            </p>
                        </div>
                    </div>
                </div>
